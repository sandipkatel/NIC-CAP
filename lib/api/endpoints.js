...
export const ENDPOINTS = {
  ...
  events: {
    ...
    addTeamMember: (id) => `/events/${id}/team-members/`,
    removeTeamMember: (eventId, ambassadorId) => `/events/${eventId}/team-members/${ambassadorId}/remove/`,
    submitReport: (id) => `/events/${id}/report/`,
    uploadReportImage: (reportId) => `/events/reports/${reportId}/images/`,
  },
};